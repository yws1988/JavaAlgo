...
/*
 Algorithm that can be used to find maximum-weight matchings in bipartite graphs,
 which is sometimes called the assignment problem.
*/
...
public class HungarianMatching {
    ...
    public static int getMaxCost(int[][] arr, int N) {
    ...
    public static int getMinCostWithDifferentDimensions(int[][] arr, int M, int N) {
