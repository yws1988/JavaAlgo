...
public class BiConnected {
    ...
    public static int step;
    public static int[] getBiConnectedComponents(List<Integer>[] graph) {
        step = 0;
        int v = graph.length;
        boolean[] visited = new boolean[v];
        int[] parents = new int[v];
    ...
    public static void dfsComponents(int s, List<Integer>[] graph, boolean[] vs, int[] dist, int[] low, int[] parents, int[] components) {
        vs[s] = true;
        dist[s] = ++step;
        low[s] = step;
